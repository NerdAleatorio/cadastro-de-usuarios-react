            ...
            <div className="form">
                ...
                <div className="row">
                    <div className="col-12 d-flex justify-content-end">
                        <button className="btn bnt-primary" onClick={e => this.save(e)}>
                            Salvar
                        </button>

                        <button className="btn bnt-secondary" onClick={e => this.clear(e)}>
                            Cancelar
                        </button>
                    </div>
                </div>
            ...
            return (
                <tr key={user.id}>
                    ...
                    <td>
                        ...
                        <button className="btn-danger" onClick={() => this.remove(user)}>
